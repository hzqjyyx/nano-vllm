...
#   -n CONTAINER_NAME  Container name (default: vllm-dev)
# Example: ./docker_run.sh -p 2222 -ws /path/to/workspace
...
IMAGE_NAME="vllm-openai:v0.11.0.dev"
DOCKER_RT="--runtime nvidia --gpus all"
SSH_PORT=${SSH_PORT:-2222}
WORKSPACE_DIR=${WORKSPACE_DIR:-~/workspace}
CONTAINER_NAME=${CONTAINER_NAME:-vllm-dev}

echo "Starting VLLM Development Docker container in background..."
